...
from lightningdit_diffusers.models.swiglu_ffn import SwiGLUFFN 
from lightningdit_diffusers.models.pos_embed import VisionRotaryEmbeddingFast
from lightningdit_diffusers.models.rmsnorm import RMSNorm
...
@dataclass
class LightningDiTTransformer2DOutput(BaseOutput):
...
class LightningDiTTransformer2DModel(ModelMixin, ConfigMixin):
    ...
    def forward(self, x, t=None, y=None, return_dict: bool = False):
        """
        ...
        if not return_dict:
            return x
        return LightningDiTTransformer2DOutput(sample=x)
...
def LightningDiT_XL_1(**kwargs):
    return LightningDiTTransformer2DModel(depth=28, hidden_size=1152, patch_size=1, num_heads=16, **kwargs)

def LightningDiT_XL_2(**kwargs):
    return LightningDiTTransformer2DModel(depth=28, hidden_size=1152, patch_size=2, num_heads=16, **kwargs)

def LightningDiT_L_2(**kwargs):
    return LightningDiTTransformer2DModel(depth=24, hidden_size=1024, patch_size=2, num_heads=16, **kwargs)

def LightningDiT_B_1(**kwargs):
    return LightningDiTTransformer2DModel(depth=12, hidden_size=768, patch_size=1, num_heads=12, **kwargs)

def LightningDiT_B_2(**kwargs):
    return LightningDiTTransformer2DModel(depth=12, hidden_size=768, patch_size=2, num_heads=12, **kwargs)

def LightningDiT_1p0B_1(**kwargs):
    return LightningDiTTransformer2DModel(depth=24, hidden_size=1536, patch_size=1, num_heads=24, **kwargs)

def LightningDiT_1p0B_2(**kwargs):
    return LightningDiTTransformer2DModel(depth=24, hidden_size=1536, patch_size=2, num_heads=24, **kwargs)

def LightningDiT_1p6B_1(**kwargs):
    return LightningDiTTransformer2DModel(depth=28, hidden_size=1792, patch_size=1, num_heads=28, **kwargs)

def LightningDiT_1p6B_2(**kwargs):
    return LightningDiTTransformer2DModel(depth=28, hidden_size=1792, patch_size=2, num_heads=28, **kwargs)
